...
namespace Loggly.Retrieval
{
    public struct OrderedEvents
    {
        ...
        public OrderedEvents
            (HttpClient client, Expression<Func<FilteredEvents.Event, FilteredEvents.Bool>> pattern, Expression<Func<DatedEvents.Event, DatedEvents.Bool>> timeRange, bool descending)
        {
            _client = client;
            _pattern = pattern;
